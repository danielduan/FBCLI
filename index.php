...
<span id="prompt">[<span class="username">guest</span>@facebook.com ~]$ <input autofocus='autofocus' id='cline' type='text' size='65' name='cline' maxlength='100'></br></span>
  ...
  <a href="http://www2.clustrmaps.com/user/5e210a124"><img src="http://www2.clustrmaps.com/stats/maps-no_clusters/www.fbcli.net-thumb.jpg" width="120px" alt="Locations of visitors to this page" />
</a>
  </div>
  <div id="footer">
